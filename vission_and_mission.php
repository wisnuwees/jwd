...
<head>
    <meta charset="utf-8">
    <title>VISSION AND MISSION UNIT USAHA PANCABUDI</title>
            ...
            <div class="row gx-5 justify-content-start">
                <div class="col-lg-7">
                    <div class="border-start border-5 border-dark ps-5 mb-5">
                        <h1 class="display-5 text-uppercase text-black mb-0">Our Vission</h1>
                    </div>
                    <p class="text-black mb-4">
					<?php
					include"sambung.php";					
					$query = mysqli_query($link,"select * from visi_misi where id_visi_misi='1'");
					$jmlh=mysqli_fetch_array($query);
						echo"$jmlh[2]";
					?>
					</p>
	...
	<div class="container-fluid bg-offer my-5 py-5">
        <div class="container py-5">
            <div class="row gx-5 justify-content-start">
                <div class="col-lg-7">
                    <div class="border-start border-5 border-dark ps-5 mb-5">
                        <h1 class="display-5 text-uppercase text-black mb-0">Our Mission</h1>
                    </div>
                    <?php
					include"sambung.php";					
					$query = mysqli_query($link,"select * from visi_misi where id_visi_misi='1'");
