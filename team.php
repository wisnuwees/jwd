...
<head>
    <meta charset="utf-8">
    <title>TEAM UNIT USAHA PANCABUDI</title>
			...
			<?php
                    ...
                    <div class='row g-0 bg-light overflow-hidden'>
                        <div class='col-12 col-sm-5 h-100'>
                            <img class='img-fluid h-100' src='$jmlh[5]' style='object-fit: cover;'>
                        </div>
                        <div class='col-12 col-sm-7 h-100 d-flex flex-column justify-content-center'>
                            <div class='p-4'>
                                <div class='d-flex mb-3'>
                                    <small class='me-3'><i class='bi bi-bookmarks me-2'></i>Panca Budi</small>
                                    <small><i class='bi bi-calendar-date me-2'></i>Medan</small>
                                </div>
                                <h5 class='text-uppercase mb-3'>$jmlh[2]</h5>
                                <p>$jmlh[3]-$jmlh[4]</p>
                            </div>
                        </div>
                    </div>
